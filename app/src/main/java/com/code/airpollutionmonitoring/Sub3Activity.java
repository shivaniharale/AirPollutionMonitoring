...
public class Sub3Activity<name> extends AppCompatActivity {
    private static final String TAG = "Sub3Activity";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        String value = temp.getString("field3");
                    ...
                    {
                        message="Hazardous CO level:Evacuate immediately";
                        addNotification(message);
                        createSMS(message);
                    }
